<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/assets/vendor/linearicons/style.css')?>">
	<!-- MAIN CSS -->
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url('assets/assets/img/logo.png')?>">
	<link rel="icon" type="image/png" sizes="96x96" href="<?php echo base_url('assets/assets/img/logo.png')?>">
	<style>
      #map {
        height: 400px;
        width: 100%;
